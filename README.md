...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (player3, obstacle) {
    info.changeScoreBy(0)
})
// Eat pizzas
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    pizzas = sprites.allOfKind(SpriteKind.Food)
    for (let pizza2 of pizzas) {
        if (player1.overlapsWith(pizza2)) {
            pizza2.destroy()
...
controller.player2.onButtonEvent(ControllerButton.A, ControllerButtonEvent.Pressed, function () {
    pizzas2 = sprites.allOfKind(SpriteKind.Food)
    for (let pizza3 of pizzas2) {
        if (player2.overlapsWith(pizza3)) {
            pizza3.destroy()
...
for (let index = 0; index < 7; index++) {
    obstacle = sprites.create(img`
        ...
        . . . . 8 8 8 8 8 8 . . . . 
        `, SpriteKind.Enemy)
    obstacle.setPosition(Math.randomRange(10, 150), Math.randomRange(10, 110))
    obstacle.setVelocity(Math.randomRange(-50, 50), Math.randomRange(-50, 50))
